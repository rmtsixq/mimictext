        ...
        <nav className="relative backdrop-blur-sm">
            ...
            <div className="flex justify-between h-16 items-center">
              ...
              <div className="hidden md:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  <button onClick={() => setCurrentPage('home')} className="text-gray-300 hover:text-neon-purple px-3 py-2 rounded-md text-sm font-medium transition-colors">Home</button>
                  <button onClick={() => setCurrentPage('pricing')} className="text-gray-300 hover:text-neon-purple px-3 py-2 rounded-md text-sm font-medium transition-colors">Pricing</button>
                  <button
          ...
          <div className={`md:hidden ${isMobileMenuOpen ? 'block' : 'hidden'}`}>
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-mat-black/95 backdrop-blur-sm">
              <button onClick={() => setCurrentPage('home')} className="text-gray-300 hover:text-neon-purple block px-3 py-2 rounded-md text-base font-medium">Home</button>
              <button onClick={() => setCurrentPage('pricing')} className="text-gray-300 hover:text-neon-purple block px-3 py-2 rounded-md text-base font-medium">Pricing</button>
              <button
